...
python_training_routine = os.path.join(
    project_dir, "scripts_training", "train_predict_state.py"
)
python_verification_routine = os.path.join(
    project_dir, "scripts_training", "verify_DeepEnsemble.py"
)
# -----------------------------------------------------------------------------.
