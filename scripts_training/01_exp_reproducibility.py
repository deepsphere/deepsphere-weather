...
for i in range(1, n_models+1): 
    ...
    cfg['model_settings']["model_name_suffix"] = "WeightInitFixed-ShuffleNo-Model_" + str(i)
...
for i in range(1, n_models+1): 
    ...
    # Define custom prefix and suffix of model name 
    # - Default: RNN-AR6-UNetSpherical-Healpix_400km-Graph_knn-k20-MaxAreaPooling
    cfg['model_settings']["model_name_suffix"] = "WeightInitFixed-ShuffleFixed-Model_" + str(i)
    cfg['model_settings']["model_name_prefix"] = model_name_prefix  
...
for i in range(1, n_models+1): 
    ...
    # Define custom prefix and suffix of model name 
    # - Default: RNN-AR6-UNetSpherical-Healpix_400km-Graph_knn-k20-MaxAreaPooling
    cfg['model_settings']["model_name_suffix"] = "WeightInitFixed-ShuffleRandom-Model_" + str(i)
    cfg['model_settings']["model_name_prefix"] = model_name_prefix  
...
for i in range(1, n_models+1): 
    ...
    # Define custom prefix and suffix of model name 
    # - Default: RNN-AR6-UNetSpherical-Healpix_400km-Graph_knn-k20-MaxAreaPooling
    cfg['model_settings']["model_name_suffix"] = "WeightInitRandom-ShuffleFixed-Model_" + str(i)
    cfg['model_settings']["model_name_prefix"] = model_name_prefix  
...
for i in range(1, n_models+1): 
    ...
    # Define custom prefix and suffix of model name 
    # - Default: RNN-AR6-UNetSpherical-Healpix_400km-Graph_knn-k20-MaxAreaPooling
    cfg['model_settings']["model_name_suffix"] = "WeightInitRandom-ShuffleNo-Model_" + str(i)
    cfg['model_settings']["model_name_prefix"] = model_name_prefix  
...
for i in range(1, n_models+1): 
    ...
    # Define custom prefix and suffix of model name 
    # - Default: RNN-AR6-UNetSpherical-Healpix_400km-Graph_knn-k20-MaxAreaPooling
    cfg['model_settings']["model_name_suffix"] = "WeightInitRandom-ShuffleRandom-Model_" + str(i)
    cfg['model_settings']["model_name_prefix"] = model_name_prefix  
