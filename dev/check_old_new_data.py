...
new_data_dynamic = xr.open_zarr(os.path.join(new_data_sampling_dir, "Data","dynamic", "time_chunked", "dynamic.zarr"))[['z500','t850']]
new_data_bc = xr.open_zarr(os.path.join(new_data_sampling_dir, "Data","bc", "time_chunked", "bc.zarr")) 

old_data_dynamic_z500 = xr.open_dataset(os.path.join(old_data_sampling_dir, "data","geopotential_500", "geopotential_500_5.625deg.nc"))
old_data_dynamic_t850 = xr.open_dataset(os.path.join(old_data_sampling_dir, "data","temperature_850", "temperature_850_5.625deg.nc"))
old_data_bc = xr.open_dataset(os.path.join(old_data_sampling_dir, "data","toa_incident_solar_radiation", "toa_incident_solar_radiation_5.625deg.nc"))
...
old_clim = xr.open_dataset(os.path.join(old_data_sampling_dir, "Climatology",clim_name))
new_clim = xr.open_dataset(os.path.join(new_data_sampling_dir, "Climatology",clim_name))
...
old_scaler = xr.open_dataset(os.path.join(old_data_sampling_dir, "Scalers",scaler_name)) 
new_scaler = xr.open_dataset(os.path.join(new_data_sampling_dir, "Scalers",scaler_name))
