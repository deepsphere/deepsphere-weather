...
RNN_cubed_skills = xr.open_dataset(
    os.path.join(
        base_dir,
        "experiments_samplings",
        "RNN-UNetSpherical-cubed-24-k20-MaxAreaPooling-float32-AR6-LinearStep",
        "model_skills/deterministic_global_skill.nc",
    )
)
RNN_equi_skills = xr.open_dataset(
    os.path.join(
        base_dir,
        "experiments_equiangular",
        "RNN-UNetSpherical-equiangular-[36, 72]-k20-MaxPooling-float32-AR6-LinearStep",
...
RNN_gauss_skills = xr.open_dataset(
    os.path.join(
        base_dir,
        "experiments_samplings",
        "RNN-UNetSpherical-gauss-48-k20-MaxAreaPooling-float32-AR6-LinearStep",
        "model_skills/deterministic_global_skill.nc",
    )
)
RNN_healpix_skills = xr.open_dataset(
    os.path.join(
        base_dir,
        "experiments_samplings",
        "RNN-UNetSpherical-healpix-16-k20-MaxAreaPooling-float32-AR6-LinearStep",
        "model_skills/deterministic_global_skill.nc",
    )
)
RNN_icos_skills = xr.open_dataset(
    os.path.join(
        base_dir,
        "experiments_samplings",
...
RNN_not_well_trained1_skills = xr.open_dataset(
    os.path.join(
        new_dir,
        "OLD_fine_tuned1-RNN-AR6-UNetSpherical-Healpix_400km-Graph_knn-k20-MaxAreaPooling",
        "model_skills/deterministic_global_skill.nc",
    )
)
RNN_well_trained_skills = xr.open_dataset(
    os.path.join(
        new_dir,
...
RNN_well_trained2_skills = xr.open_dataset(
    os.path.join(
        new_dir,
...
RNN_well_trained3_skills = xr.open_dataset(
    os.path.join(
        new_dir,
...
RNN_well_trained3disal_skills = xr.open_dataset(
    os.path.join(
        new_dir,
        "OLD_fine_tuned1_disal-RNN-AR6-UnetSpherical-Healpix_400km-Graph_knn-k20-MaxAreaPooling",
        "model_skills/deterministic_global_skill.nc",
    )
)

RNN_ReZero_skills = xr.open_dataset(
    os.path.join(
        new_dir,
        "OLD_fine_tuned4_ReZero-RNN-AR6-UNetSpherical-Healpix_400km-Graph_knn-k20-MaxAreaPooling",
        "model_skills/deterministic_global_skill.nc",
    )
)
...
benchmark_global_skill(
    ...
    n_leadtimes=20,
).savefig(os.path.join(figs_dir, "Benchmark_RMSE_Samplings1.png"))
...
benchmark_global_skills(
    ...
    n_leadtimes=20,
).savefig(os.path.join(figs_dir, "Benchmark_Overview_Samplings1.png"))
