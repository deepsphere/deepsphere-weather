...
bc_scaler = LoadScaler(os.path.join(data_sampling_dir, "Scalers", "GlobalMinMaxScaler_bc.nc"))
...
dynamic_scaler = LoadScaler(os.path.join(data_sampling_dir, "Scalers", "GlobalMinMaxScaler_dynamic.nc"))
