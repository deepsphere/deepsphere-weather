...
class ResBlock(torch.nn.Module):
    ...
    def __init__(
        self, in_channels, out_channels, laplacian, convblock_kwargs, **kwargs
    ):
        super().__init__()
        ##--------------------------------------------------------
        # ResBlock options
...
class UNetSpherical(UNet, torch.nn.Module):
    ...
    def encode(self, x):
        ...
        x = x.reshape(
            batch_size, self.input_n_node, self.input_channels
    ...
    def decode(self, x_enc3, x_enc2, x_enc1, idx2, idx1, x_last_timestep):
        ...
        x = x.reshape(
            batch_size, self.output_n_node, self.output_n_time, self.output_n_feature
        )
        x = (
