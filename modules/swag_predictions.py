...
def AutoregressiveSWAGPredictions(
    model,
    exp_dir,
    # Data
    ...
    # Save ensemble
    forecast_zarr_fpath = os.path.join(
        exp_dir, f"model_predictions/spatial_chunks/test_pred_{sampling_scale_str}.zarr"
    )
