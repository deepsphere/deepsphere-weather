...
##----------------------------------------------------------------------------.
def load_dynamic_dataset(data_dir, chunk_size):
...
def load_bc_dataset(data_dir, chunk_size): 
...
def load_static_dataset(data_dir):
    return xr.open_dataset(f'{data_dir}constants/constants_5.625deg_standardized.nc')
    
##----------------------------------------------------------------------------.
 
def readDatasets(data_dir, feature_type, chunk_size):
