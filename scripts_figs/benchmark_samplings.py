...
benchmark_global_skill(
    ...
    n_leadtimes=20,
).savefig(os.path.join(figs_dir, "Benchmark_RMSE_Samplings.png"))
...
benchmark_global_skills(
    ...
    n_leadtimes=20,
).savefig(os.path.join(figs_dir, "Benchmark_Overview_Samplings.png"))
...
benchmark_global_skill(
    ...
    colors_dict=colors_dict,
    n_leadtimes=20,
).savefig(os.path.join(figs_dir, "Benchmark_RMSE_Samplings_Weyn.png"))
