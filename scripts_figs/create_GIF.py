...
model_dir = os.path.join(
    "/data/weather_prediction/experiments_GG/new_old_archi", model_name
)
...
create_gif_forecast_error(
    gif_fpath=os.path.join(figs_dir, "Forecast_State_Error.gif"),
...
create_gif_forecast_anom_error(
    gif_fpath=os.path.join(figs_dir, "Forecast_Anom_Error.gif"),
    ds_forecast=ds_forecast,
    ds_obs=ds_obs,
