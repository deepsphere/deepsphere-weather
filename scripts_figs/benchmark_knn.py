...
k8_skills = xr.open_dataset(os.path.join(base_dir, "experiments_knn" , "RNN-UNetSpherical-healpix-16-k8-MaxAreaPooling-float32-AR2-LinearStep", "model_skills/deterministic_global_skill.nc"))
k20_skills = xr.open_dataset(os.path.join(base_dir, "experiments_knn" , "RNN-UNetSpherical-healpix-16-k20-MaxAreaPooling-float32-AR2-LinearStep", "model_skills/deterministic_global_skill.nc"))
k40_skills = xr.open_dataset(os.path.join(base_dir, "experiments_knn" , "RNN-UNetSpherical-healpix-16-k40-MaxAreaPooling-float32-AR2-LinearStep", "model_skills/deterministic_global_skill.nc"))
k60_skills = xr.open_dataset(os.path.join(base_dir, "experiments_knn" , "RNN-UNetSpherical-healpix-16-k60-MaxAreaPooling-float32-AR2-LinearStep", "model_skills/deterministic_global_skill.nc"))
k20_old_skills = xr.open_dataset(os.path.join(base_dir, "experiments_samplings" , "RNN-UNetSpherical-healpix-16-k20-MaxAreaPooling-float32-AR2-LinearStep", "model_skills/deterministic_global_skill.nc"))
...
benchmark_global_skill(skills_dict=skills_dict, 
                       ...
                       n_leadtimes=20).savefig(os.path.join(figs_dir, "Benchmark_RMSE_knn.png"))
...
benchmark_global_skills(skills_dict=skills_dict1, 
                        ...
                        n_leadtimes=20).savefig(os.path.join(figs_dir, "Benchmark_Overview_knn.png"))
