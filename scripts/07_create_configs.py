...
dict_samplings = {
    "Healpix_400km": {"sampling": "healpix", "resolution": 16},
    "Equiangular_400km": {"sampling": "equiangular", "resolution": [36, 72]},
    "Equiangular_400km_tropics": {"sampling": "equiangular", "resolution": [46, 92]},
    "Icosahedral_400km": {"sampling": "icosahedral", "resolution": 16},
    "O24": {"sampling": "gauss", "resolution": 48},
    "Cubed_400km": {"sampling": "cubed", "resolution": 24},
}
    ...
    for knn in knn_list:
        for pool_method in pool_methods:
            for sampling_name in dict_samplings.keys():
                ...
                custom_cfg["model_settings"]["resolution"] = dict_samplings[
                    sampling_name
                ]["resolution"]
                ...
                # Write config file
                tmp_config_name = (
                    "-".join([pool_method + "Pool", "k" + str(knn)]) + ".json"
                )
                write_config_file(
