...
for sampling_name in sampling_name_list:
    ...
    pygsp_graph = get_pygsp_graph(sampling = sampling_infos[sampling_name]['sampling'], 
                                  resolution = sampling_infos[sampling_name]['resolution'])
    ds_persistence_skill = ds_persistence_skill.sphere.add_nodes_from_pygsp(pygsp_graph=pygsp_graph)
    ds_persistence_skill = ds_persistence_skill.sphere.add_SphericalVoronoiMesh(x='lon', y='lat')
