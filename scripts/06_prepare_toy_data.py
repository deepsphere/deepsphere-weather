...
for sampling_name in spherical_samplings:
    ...
    # Define paths
    src_dynamic_fpath = os.path.join(
        full_data_dir, "Data", "dynamic", "time_chunked", "dynamic.zarr"
    )
    dst_dynamic_fpath = os.path.join(
        toy_data_dir, "Data", "dynamic", "time_chunked", "dynamic.zarr"
    )
